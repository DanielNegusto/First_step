...
from src.services import get_info_from_excel, analyze_cashback


def test_get_info_from_excel():
    # Создаем тестовый DataFrame
    df = pd.DataFrame({'Дата операции': ['01.01.2022 12:00:00'], 'Категория': ['Еда'], 'Бонусы (включая кэшбэк)': ['100']})
